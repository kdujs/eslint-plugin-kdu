...
/**
 * @param {KElement & { endTag: KEndTag }} element
 */
 ...
 * @param {KElement & { endTag: KEndTag }} node The element node to check.
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: 'https://kdujs-eslint.web.app/rules/multiline-html-element-content-newline.html'
    },
    fixable: 'whitespace',
    schema: [
      {
  ...
  create(context) {
    ...
    return utils.defineTemplateBodyVisitor(context, {
      KElement(node) {
        ...
        const element = /** @type {KElement & { endTag: KEndTag }} */ (node)
