 ...
 */
function getKduNextTickNode(identifier, context) {
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: 'https://kdujs-eslint.web.app/rules/valid-next-tick.html'
    },
    fixable: 'code',
    schema: []
  },
  ...
  create(context) {
    return utils.defineKduVisitor(context, {
      ...
      Identifier(node) {
        const nextTickNode = getKduNextTickNode(node, context)
