...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      categories: null,
      url: 'https://kdujs-eslint.web.app/rules/no-this-in-before-route-enter.html'
    },
    fixable: null,
    schema: [],
    messages: {
      disallow:
        "'beforeRouteEnter' does NOT have access to `this` component instance. https://kdujs-router.web.app/guide/advanced/navigation-guards.html#in-component-guards."
    }
  },
