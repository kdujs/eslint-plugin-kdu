...
module.exports = {
  meta: {
    docs: {
      description: 'disallow unnecessary `k-bind` directives',
      categories: undefined,
      url: 'https://kdujs-eslint.web.app/rules/no-useless-k-bind.html'
    },
    fixable: 'code',
    messages: {
      unexpected: 'Unexpected `k-bind` with a string literal value.'
    },
    schema: [
      {
        type: 'object',
  ...
  create(context) {
     ...
     * @param {KDirective} node the node to check
     */
