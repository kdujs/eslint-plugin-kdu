...
const traverseNodes = require('kdu-eslint-parser').AST.traverseNodes
...
const defaultOrder = [
  ...
  'extends',
  'mixins',
  ['provide', 'inject'], // for Kdu.js 2.2.0+

  // Page Options (component rendered as a router page)
  'ROUTER_GUARDS', // for Kdu Router
  'layout', // for Dorayaki
  'middleware', // for Dorayaki
  'validate', // for Dorayaki
  'scrollToTop', // for Dorayaki
  'transition', // for Dorayaki
  'loading', // for Dorayaki

  // Interface (the interface to the component)
  'inheritAttrs',
  'model',
  ['props', 'propsData'],
  'emits', // for Kdu.js 3.x
...
const groups = {
  LIFECYCLE_HOOKS: [
    ...
    'activated',
    'deactivated',
    'beforeUnmount', // for Kdu.js 3.x
    'unmounted', // for Kdu.js 3.x
    'beforeDestroy',
    'destroyed',
    'renderTracked', // for Kdu.js 3.x
    'renderTriggered', // for Kdu.js 3.x
    'errorCaptured' // for Kdu.js 2.5.0+
  ],
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: 'https://kdujs-eslint.web.app/rules/order-in-components.html'
    },
