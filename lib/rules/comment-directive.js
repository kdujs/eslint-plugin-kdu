 ...
 * @param {KDocumentFragment} documentFragment The document fragment.
 * @returns {KElement[]} The top-level elements
 */
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      categories: ['base'],
      url: 'https://kdujs-eslint.web.app/rules/comment-directive.html'
    },
    schema: [
      {
        type: 'object',
