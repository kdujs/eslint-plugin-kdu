/**
 * @author NKDuy
 * @fileoverview Rule to check for max length on a line of Kdu file.
 */
'use strict'
...
module.exports = {
  meta: {
    ...
    docs: {
      description: 'enforce a maximum line length in `.kdu` files',
      categories: undefined,
      url: 'https://kdujs-eslint.web.app/rules/max-len.html',
      extensionRule: true,
  ...
  create(context) {
    ...
    /** @type {number} */
    const tabWidth = typeof options.tabWidth === 'number' ? options.tabWidth : 2 // default value of `kdu/html-indent`
    /** @type {number} */
    ...
    return utils.compositingVisitors(
      utils.defineTemplateBodyVisitor(context, {
        /** @param {KLiteral} node */
        'KAttribute[directive=false] > KLiteral'(node) {
