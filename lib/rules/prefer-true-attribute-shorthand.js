...
module.exports = {
  meta: {
    ...
    docs: {
      description:
        'require shorthand form attribute when `k-bind` value is `true`',
      categories: undefined,
      url: 'https://kdujs-eslint.web.app/rules/prefer-true-attribute-shorthand.html'
    },
    fixable: null,
    hasSuggestions: true,
    ...
    messages: {
      ...
      rewriteIntoLongKduProp:
        'Rewrite this prop into long-form Kdu component prop.',
      ...
      KAttribute(node) {
        ...
        if (option === 'never' && !node.directive && !node.value) {
          context.report({
            ...
            suggest: [
              {
                messageId: 'rewriteIntoLongKduProp',
                fix: (fixer) =>
