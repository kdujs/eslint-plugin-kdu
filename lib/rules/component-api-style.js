...
/**
 * @typedef { 'script-setup' | 'composition' | 'composition-kdu2' | 'options' } PreferOption
 *
...
function parseOptions(options) {
  ...
  for (const prefer of preferOptions) {
    ...
    } else if (prefer === 'composition-kdu2') {
      opts.allowsSFC.compositionKdu2 = true
      opts.allowsOther.compositionKdu2 = true
  ...
  if (
    ...
    !opts.allowsOther.compositionKdu2 &&
...
const COMPOSITION_API_KDU2_OPTIONS = new Set([
  'setup',
  'render', // https://github.com/kdujs/composition-api#template-refs
  'renderTracked', // https://github.com/kdujs/composition-api#missing-apis
  'renderTriggered' // https://github.com/kdujs/composition-api#missing-apis
])
 ...
 * @param {boolean} [allowsOpt.compositionKdu2]
...
function buildAllowedPhrase(allowsOpt) {
  ...
  if (allowsOpt.compositionKdu2) {
    phrases.push('Composition API (Kdu 2)')
  }
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: 'https://kdujs-eslint.web.app/rules/component-api-style.html'
    },
    fixable: null,
    schema: [
      {
      ...
      utils.defineKduVisitor(context, {
        onKduObjectEnter(node) {
          const allows = utils.isSFCObject(context, node)
            ...
            : options.allowsOther
          if (
            (allows.composition || allows.compositionKdu2) &&
            allows.options
          ) {
            return
          }
          const apis = [
            ...
            {
              allow: allows.compositionKdu2,
              options: COMPOSITION_API_KDU2_OPTIONS,
              apiName: 'Composition API (Kdu 2)'
            }
          ]
