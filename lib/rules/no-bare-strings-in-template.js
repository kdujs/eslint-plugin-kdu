...
const DEFAULT_DIRECTIVES = ['k-text']
 ...
 * @param {KExpressionContainer} value
 * @returns { string | null }
 */
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: 'https://kdujs-eslint.web.app/rules/no-bare-strings-in-template.html'
    },
    schema: [
      {
        type: 'object',
    ...
    return utils.defineTemplateBodyVisitor(context, {
      ...
      KAttribute(node) {
        ...
        if (node.directive === false) {
          ...
          const directive = `k-${node.key.name.name}`
