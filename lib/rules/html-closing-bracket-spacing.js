 ...
 * @returns {Options & { detectType: (node: KStartTag | KEndTag) => 'never' | 'always' | null }} The normalized options.
 */
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: 'https://kdujs-eslint.web.app/rules/html-closing-bracket-spacing.html'
    },
    schema: [
      {
        type: 'object',
