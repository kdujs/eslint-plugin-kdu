...
module.exports = {
  meta: {
    ...
    docs: {
      description:
        'disallow using deprecated `tag` property on `RouterLink` (in Kdu.js 3.0.0+)',
      categories: ['kdu3-essential'],
      url: 'https://kdujs-eslint.web.app/rules/no-deprecated-router-link-tag-prop.html'
    },
    fixable: null,
    schema: [
      {
