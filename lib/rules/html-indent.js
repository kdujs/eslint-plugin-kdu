...
function create (context) {
    ...
    if (nodeList.length >= 1) {
      ...
      if (baseToken != null) {
        ...
        if (alignVertically) {
          ...
          // So it's possible to force proper position for KAttributes
  ...
  return utils.defineTemplateBodyVisitor(context, processIgnores({
    ...
    // Do validation.
    "KElement[parent.type='KDocumentFragment']:exit" (node) {
      let comments = []
