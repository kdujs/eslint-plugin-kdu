...
module.exports = {
  meta: {
    ...
    docs: {
      description:
        "disallow element's child contents which would be overwritten by a directive like `k-html` or `k-text`",
      categories: undefined,
      url: 'https://kdujs-eslint.web.app/rules/no-child-content.html'
    },
    fixable: null,
    schema: [
      {
  ...
  create(context) {
    ...
    return defineTemplateBodyVisitor(context, {
      /** @param {KDirective} directiveNode */
      'KAttribute[directive=true]'(directiveNode) {
        ...
        if (
          ...
          context.report({
            ...
            message:
              'Child content is disallowed because it will be overwritten by the k-{{ directiveName }} directive.',
            data: { directiveName },
            suggest: [
              {
