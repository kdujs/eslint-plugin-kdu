...
/**
 * @typedef { {name: string, node: KDirectiveKey, modifiers: string[] } } EventDirective
 */
 ...
 *
 * @param {KStartTag} startTag Element startTag
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: 'https://kdujs-eslint.web.app/rules/use-k-on-exact.html'
    },
    fixable: null,
    schema: []
  },
