...
const ELEMENT_TYPE = Object.freeze({
  ...
  COMPONENT: 'Kdu.js custom components',
  SVG: 'SVG elements',
 ...
 * @param {KElement} node The element node to get.
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: 'https://github.com/kdujs/eslint-plugin-kdu/blob/v5.0.0/docs/rules/html-self-closing.md'
    },
    fixable: 'code',
    schema: {
      definitions: {
