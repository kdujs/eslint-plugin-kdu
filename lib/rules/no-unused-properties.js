 ...
 * @typedef {object} KduComponentPropertiesContainer
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: 'https://kdujs-eslint.web.app/rules/no-unused-properties.html'
    },
    fixable: null,
    schema: [
      {
  ...
  create(context) {
    ...
    /** @type {Map<ASTNode, KduComponentPropertiesContainer>} */
    const kduComponentPropertiesContainerMap = new Map()

    /**
     * @param {ASTNode} node
     * @returns {KduComponentPropertiesContainer}
     */
    function getKduComponentPropertiesContainer(node) {
      let container = kduComponentPropertiesContainerMap.get(node)
      if (!container) {
        container = {
          properties: [],
          propertyReferences: [],
        ...
        kduComponentPropertiesContainerMap.set(node, container)
      }
      return container
    }
    /**
    ...
    function reportUnusedProperties() {
      for (const container of kduComponentPropertiesContainerMap.values()) {
    ...
    const scriptVisitor = utils.compositingVisitors(
      utils.defineScriptSetupVisitor(context, {
        onDefinePropsEnter(node, props) {
          ...
          const container = getKduComponentPropertiesContainer(node)
      ...
      utils.defineKduVisitor(context, {
        ...
        'ObjectExpression > Property > :function[params.length>0]'(
          ...
          const container = getKduComponentPropertiesContainer(kduData.node)
