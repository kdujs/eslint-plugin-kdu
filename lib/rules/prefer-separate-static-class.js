...
/**
 * @param {Expression | KForExpression | KOnExpression | KSlotScopeExpression | KFilterSequenceExpression} expressionNode
...
/**
 * @param {KAttribute | KDirective} attributeNode
 * @returns {attributeNode is KAttribute & { value: KLiteral }}
 */
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: 'https://kdujs-eslint.web.app/rules/prefer-separate-static-class.html'
    },
    fixable: 'code',
    schema: [],
    messages: {
  ...
  create(context) {
    return defineTemplateBodyVisitor(context, {
      /** @param {KDirectiveKey} directiveKeyNode */
      "KAttribute[directive=true] > KDirectiveKey[name.name='bind'][argument.name='class']"(
        directiveKeyNode
      ) {
