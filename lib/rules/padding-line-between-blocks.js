 ...
 * @param {KElement} prevBlock The previous block to check.
 * @param {KElement} nextBlock The next block to check.
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: 'https://kdujs-eslint.web.app/rules/padding-line-between-blocks.html'
    },
    fixable: 'whitespace',
    schema: [
      {
