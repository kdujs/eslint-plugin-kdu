...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: 'https://github.com/kdujs/eslint-plugin-kdu/blob/v5.0.0/docs/rules/mustache-interpolation-spacing.md'
    },
    fixable: 'whitespace',
    schema: [
      {
  ...
  create (context) {
    ...
    return utils.defineTemplateBodyVisitor(context, {
      'KExpressionContainer[expression!=null]' (node) {
        ...
        if (
          !openBrace ||
          !closeBrace ||
          openBrace.type !== 'KExpressionStart' ||
          closeBrace.type !== 'KExpressionEnd'
        ) {
          return
        }
