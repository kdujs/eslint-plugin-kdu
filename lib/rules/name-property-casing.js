/**
 * @fileoverview Requires specific casing for the name property in Kdu components
 * @author NKDuy
 */
'use strict'
...
module.exports = {
  meta: {
    type: 'suggestion',
    docs: {
      description: 'enforce specific casing for the name property in Kdu components',
      category: 'strongly-recommended',
      url: 'https://github.com/kdujs/eslint-plugin-kdu/blob/v5.0.0/docs/rules/name-property-casing.md'
    },
