...
/**
 * @typedef {import('../../typings/eslint-plugin-kdu/util-types/node').HasLocation} HasLocation
...
module.exports.defineVisitor = function create(
   ...
   * @param {KElement} node The node to set.
   * @returns {void}
   */
  ...
  function isBeginningOfElement(token, belongingNode) {
    ...
    while (node != null && node.parent != null) {
      ...
      if (parent.type === 'KExpressionContainer') {
  ...
  const visitor = {
    ...
    /** @param {KFilterSequenceExpression} node */
