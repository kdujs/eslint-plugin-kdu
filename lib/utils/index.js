...
module.exports = {
  ...
  isKduComponent (node) {
    ...
    const isFullKduComponent = node.type === 'CallExpression' &&
    ...
    const isDestructedKduComponent = callee.type === 'Identifier' &&
      callee.name === 'component'

    return isFullKduComponent || isDestructedKduComponent
  },
