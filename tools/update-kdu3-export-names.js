...
/*
 This script updates `lib/utils/kdu3-export-names.json` file from kdu type.
 */
...
async function main() {
  ...
  for await (const name of extractExportNames('kdu@^3')) {
    names.add(name)
  }
  // Update file.
  const filePath = path.resolve(
    __dirname,
    '../lib/utils/kdu3-export-names.json'
  )
