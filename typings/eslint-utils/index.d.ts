...
import { Token, Comment } from '../eslint-plugin-kdu/util-types/node'
import { ParserServices } from '../eslint-plugin-kdu/util-types/parser-services'
import eslint from 'eslint'

export function findVariable(
  initialScope: eslint.Scope.Scope,
  nameOrNode: KAST.Identifier | string
